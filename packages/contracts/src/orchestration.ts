...
/** MIME patterns accepted for document file attachments. */
export const ALLOWED_DOCUMENT_MIME_PATTERNS = [
  "application/pdf",
  "text/plain",
  "text/csv",
  "text/markdown",
...
const DOCUMENT_MIME_REGEX =
  /^(application\/pdf|text\/plain|text\/csv|text\/markdown|application\/msword|application\/vnd\.openxmlformats-officedocument\.wordprocessingml\.document|application\/vnd\.ms-excel|application\/vnd\.openxmlformats-officedocument\.spreadsheetml\.sheet)$/i;
...
export const ChatFileAttachment = Schema.Struct({
  ...
  id: ChatAttachmentId,
  name: TrimmedNonEmptyString.check(Schema.isMaxLength(255)),
  mimeType: TrimmedNonEmptyString.check(Schema.isMaxLength(100), Schema.isPattern(DOCUMENT_MIME_REGEX)),
