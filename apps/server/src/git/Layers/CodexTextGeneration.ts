...
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@xbetools/shared/git";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    const filePath = path.join(tempDir, `xbecode-${prefix}-${process.pid}-${randomUUID()}.tmp`);
