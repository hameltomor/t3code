              ...
              >
                <Toast.Root
                  className={cn(
                    ...
                    tooltipStyle
                      ? "rounded-[4px] shadow-md/5 before:rounded-[3px]"
                      : "rounded-[4px] shadow-lg/5 before:rounded-[3px]",
                  )}
