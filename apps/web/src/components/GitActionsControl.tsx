import type { GitStackedAction, GitStatusResult, ThreadId } from "@xbetools/contracts";
...
export default function GitActionsControl({ gitCwd, activeThreadId }: GitActionsControlProps) {
  ...
  }, [allSelected, isCommitDialogOpen, dialogCommitMessage, checkoutNewBranchAndRunAction, selectedFiles]);
