import type { GitStatusResult } from "@xbetools/contracts";
...
describe("resolveDefaultBranchActionDialogCopy", () => {
  ...
  it("uses push-and-pr copy when creating a PR without a commit", () => {
    ...
    assert.deepEqual(copy, {
      title: "Push & PR from default branch?",
      description:
  ...
  it("uses MR copy for gitlab provider", () => {
    ...
    assert.deepEqual(copy, {
      title: "Push & MR from default branch?",
      description:
