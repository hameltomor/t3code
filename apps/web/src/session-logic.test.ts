import { EventId, MessageId, TurnId, type OrchestrationThreadActivity } from "@xbetools/contracts";
...
describe("PROVIDER_OPTIONS", () => {
  it("marks Claude Code available and keeps Cursor as an unavailable placeholder", () => {
